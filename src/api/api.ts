...
/* eslint-disable */
/**
 * ZenFashionStudio API
 * API documentation for the ZenFashionStudio E-commerce Api
 *
 * The version of the OpenAPI document: 1.0
 * Contact: https://github.com/rahil234
 *
...
export interface LoginResendOTPDto {
    /**
     * Phone number of the user
     */
    'phone': string;
...
export const AdminApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        adminControllerCreate: async (body: object, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('adminControllerCreate', 'body', body)
         ...
         * @throws {RequiredError}
         */
        adminControllerUpdate: async (id: string, body: object, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('adminControllerUpdate', 'id', id)
            // verify required parameter 'body' is not null or undefined
            assertParamExists('adminControllerUpdate', 'body', body)
            const localVarPath = `/api/admin/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const AdminApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async adminControllerCreate(body: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.adminControllerCreate(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AdminApi.adminControllerCreate']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async adminControllerUpdate(id: string, body: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.adminControllerUpdate(id, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const AdminApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        adminControllerCreate(body: object, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.adminControllerCreate(body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        adminControllerUpdate(id: string, body: object, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.adminControllerUpdate(id, body, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AdminApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public adminControllerCreate(body: object, options?: RawAxiosRequestConfig) {
        return AdminApiFp(this.configuration).adminControllerCreate(body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public adminControllerUpdate(id: string, body: object, options?: RawAxiosRequestConfig) {
        return AdminApiFp(this.configuration).adminControllerUpdate(id, body, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const AuthApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {LoginResendOTPDto} loginResendOTPDto 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        authControllerResendOtp: async (loginResendOTPDto: LoginResendOTPDto, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'loginResendOTPDto' is not null or undefined
            assertParamExists('authControllerResendOtp', 'loginResendOTPDto', loginResendOTPDto)
            const localVarPath = `/api/auth/login/resend-otp`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(loginResendOTPDto, localVarRequestOptions, configuration)
        ...
        authControllerVerifyOtp: async (loginVerifyOTPDto: LoginVerifyOTPDto, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/auth/login/verify-otp`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const AuthApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async authControllerResendOtp(loginResendOTPDto: LoginResendOTPDto, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerResendOtp(loginResendOTPDto, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const AuthApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        authControllerResendOtp(loginResendOTPDto: LoginResendOTPDto, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.authControllerResendOtp(loginResendOTPDto, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Verify the OTP of the user.
...
export class AuthApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public authControllerResendOtp(loginResendOTPDto: LoginResendOTPDto, options?: RawAxiosRequestConfig) {
        return AuthApiFp(this.configuration).authControllerResendOtp(loginResendOTPDto, options).then((request) => request(this.axios, this.basePath));
    }
...
export const TryOnApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        tryOnControllerTryOn: async (body: object, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('tryOnControllerTryOn', 'body', body)
            const localVarPath = `/api/ai`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const TryOnApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async tryOnControllerTryOn(body: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.tryOnControllerTryOn(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const TryOnApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        tryOnControllerTryOn(body: object, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.tryOnControllerTryOn(body, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class TryOnApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public tryOnControllerTryOn(body: object, options?: RawAxiosRequestConfig) {
        return TryOnApiFp(this.configuration).tryOnControllerTryOn(body, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        userControllerFindMe(options?: RawAxiosRequestConfig): AxiosPromise<void> {
